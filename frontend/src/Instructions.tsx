...
export default function Instructions() {
  ...
  <p className="text-gray-700 dark:text-gray-300 leading-relaxed max-w-3xl">Use this portal to create, download and revoke user/device client certificates under managed Root Certificate Authorities. Administrators oversee trust anchors and audit activity.</p>
